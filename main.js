// Lightbox for resume
 ...
 // Open the Modal Resume
 function openLightboxResume() {
  document.getElementById("myLightboxResume").style.display = "block";
}

// Close the Modal Resume
function closeLightboxResume() {
  document.getElementById("myLightboxResume").style.display = "none";
}

// Lightbox for coding examples
...
// Collapse button
  ...
  function toggleResume () {
    document.getElementById("resume-content").classList.toggle("hide");
  }
  function toggleCode () {
